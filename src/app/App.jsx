...
import { getSettings, getUser, saveSettings, saveUser } from '../io/storage.js';
  ...
  return (
    <div className="app-shell">
      <div className="screen-scroll">
        ...
        {tab === 'method'  && <MethodScreen state={readingState} settings={settings} onSettingsChange={handleSettingsChange} onTab={setTab}/>}
      </div>
